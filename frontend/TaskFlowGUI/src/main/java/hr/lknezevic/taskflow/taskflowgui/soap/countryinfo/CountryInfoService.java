    ...
    extends Service
{
    ...
    public soap.countryinfo.CountryInfoServiceSoapType getCountryInfoServiceSoap() {
        return super.getPort(new QName("http://www.oorsprong.org/websamples.countryinfo", "CountryInfoServiceSoap"), soap.countryinfo.CountryInfoServiceSoapType.class);
    }
     ...
     */
    @WebEndpoint(name = "CountryInfoServiceSoap")
    public soap.countryinfo.CountryInfoServiceSoapType getCountryInfoServiceSoap(WebServiceFeature... features) {
        return super.getPort(new QName("http://www.oorsprong.org/websamples.countryinfo", "CountryInfoServiceSoap"), soap.countryinfo.CountryInfoServiceSoapType.class, features);
    }
